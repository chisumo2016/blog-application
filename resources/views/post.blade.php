                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <a class="avatar" href="{{ route('post.details',$randompost->slug) }}"><img src="{{ Storage::disk('public')->url('profile/'.$randompost->user->image) }}" alt="Profile Image"></a>

                                <div class="blog-info">

                                    {{--{{ route('post.details'. $randompost->slug) }}--}}
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-12">
                    <div class="comment-form">
                        @guest
                             <p>
                                 For post new new comment.You need to login first
