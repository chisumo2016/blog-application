...
<div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <div class="info-box bg-light-red hover-expand-effect">
                    <div class="icon">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="table-responsive">
                            <table class="table table-dark dashboard-task-infos">
                               <thead>
                                    <tr>
                                        <th>Rank</th>
                                        <th>Title</th>
                                ...
                                <tbody>
                                    @foreach($popular_posts as $key=>$post)
                                       <tr>
                                           ...
                                           <td>
                                               <a href="{{ route('post.details', $post->slug) }}" class="btn btn-primary waves-effect" target="_blank">View</a>
                                           </td>
                                       </tr>
